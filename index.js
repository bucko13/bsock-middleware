    ...
    return function (next) {
      return function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(action) {
          var _action$bsock, port, host, ssl, protocols, apiKey, _action$bsock2, type, message, acknowledge, rest, args, _socket, ack, _socket2;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  ...
                  _context3.next = _context3.t0 === 'CONNECT_SOCKET' ? 5 : _context3.t0 === 'DISCONNECT_SOCKET' ? 12 : _context3.t0 === 'EMIT_SOCKET' ? 18 : 40;
                  break;
                ...
                case 5:
                  ...
                  _action$bsock = action.bsock, port = _action$bsock.port, host = _action$bsock.host, ssl = _action$bsock.ssl, protocols = _action$bsock.protocols, apiKey = _action$bsock.apiKey;
                  ...
                  socket.on('connect', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return socket.call('auth', apiKey);
                              ...
                              listeners.forEach(function (listener) {
                                ...
                                if (ack) {
                                  ...
                                  socket.hook(event, function () {
                                    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(payload) {
                ...
                case 12:
                  ...
                  return _context3.abrupt('return', next(disconnectedAction));
                ...
                case 36:
                  ...
                  if (debug) console.error('There was a problem calling the socket:', _context3.t1);
